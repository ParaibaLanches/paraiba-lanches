...
class ApiService {
  ...
  void _handleDioError(DioException e) {
    if (e.type == DioExceptionType.connectionError ||
      ...
      throw Exception(
        'Falha na conexão com o servidor [${e.requestOptions.path}]. Verifique se o backend está rodando e reinicie se necessário.',
      );
    }
    ...
    String msg =
        ...
        'Erro de rede em: ${e.requestOptions.path}';
    ...
    final friendlyMessages = {
      ...
      'usuario nao encontrado':
          'Não encontramos você por aqui... Que tal se cadastrar? ✨',
      'senha atual incorreta':
          'A senha atual não confere, vamos tentar de novo? 📝',
      'token invalido ou expirado':
          'Ops! Sua sessão expirou. Que tal entrar de novo? 🔑',
      'pedido deve conter ao menos um item':
          'Seu carrinho está vazio! Vamos escolher algo gostoso? 🛒',
      'metodo de pagamento invalido':
          'Ops! Esse meio de pagamento não está disponível agora. 💳',
      'restaurante nao esta aceitando pedidos':
          'O restaurante está descansando agora. Volte em breve! 😴',
    };
